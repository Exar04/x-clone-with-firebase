...
export function Sidebar(props) {
    ...
    const [SidebarPages, setSidebarPages] = useState(
        [
            ...
            { id: 6, pagevar: "Profile", link: "home/profile", icon: "https://img.icons8.com/material-rounded/96/FFFFFF/user.png" }
        ])
    ...
    return (
        <div className="md:w-96 w-0 flex-none bg-zinc-950 md:h-screen flex flex-col border-r-0.5 border-0 border-slate-600">{/*SideBar*/}
